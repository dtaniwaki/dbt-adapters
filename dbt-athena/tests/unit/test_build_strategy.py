"""
Unit tests for build_strategy='subquery': verify SQL generated by incremental_insert and iceberg_merge.
"""
...
class TestIncrementalInsertWithSubquery:
    ...
    def test_subquery_too_many_partitions_raises_error(self):
        ...
        assert "build_strategy" in error_msg
...
def _render_empty_sql(compiled_code):
    ...
    incremental.sql for the build_strategy='subquery' branches. We extract it from
    the real file so the test catches drift if the line is rewritten."""
